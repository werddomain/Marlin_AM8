 ...
 * PINS: https://github.com/bigtreetech/BIGTREETECH-SKR-PRO-V1.1/blob/master/manual/SKR-PRO-V1.1-Pin.pdf
 */
#define E0_AUTO_FAN_PIN -1 //PE_5
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Z Offset Calibrate"
